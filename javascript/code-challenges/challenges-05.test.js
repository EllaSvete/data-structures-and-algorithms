...
const addValues = (arr) => {
  // Solution code here...
  return arr = arr.reduce((runningTotal, currentNumber) => {
...
const countNumberOfElements = (arr) => {
  return arr.reduce((length) => length + 1, 0);
...
const returnNames = (arr) => {
  return arr.reduce((peopleSum, personName) => {
    peopleSum.push(
      personName.name
    );
    return peopleSum;
...
const reversedString = (str) => {
  ...
  const reversedString = array.reduce((reversed, characters) => {
